...
InputStream inputStream = new FileInputStream("/Users/sven1103/git/mtb-data-specs/schemes/example/example.schema.json")
JSONObject rawSchema = new JSONObject(new JSONTokener(inputStream));
InputStream exampleJsonStream = new FileInputStream("/Users/sven1103/git/mtb-data-specs/schemes/example/example.object.json")
